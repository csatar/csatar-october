...
class TagList extends FormWidgetBase
{
    ...
    /**
     * @var string related model key for saving and reading data.
     */
    public $relationKey = false;
    ...
    public function init()
    {
        ...
        $this->relationKey = $this->useKey ? $this->getRelationModel()->getKeyName() : $this->nameFrom;
